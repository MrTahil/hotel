    ...
    public class Bookings_controller : Controller
    {
        ...
        public async Task<ActionResult<Booking>> Booking(int roomid, CreateBookingDto crtbooking)
        {
            ...
            await _context.Bookings.AddAsync(booking);
                ...
                if (guests == null)
                {
                    return StatusCode(404, "Vendég megadása szükséges foglalás elõtt");
                }
                ...
                {
                    return StatusCode(404, "Nincs létrehozott guest a felhasználóhoz, vagy nem létezõ szobára hivatkoztál");
                }
