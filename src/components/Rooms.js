  ...
  useEffect(() => {
    const fetchRooms = async () => {
      try {
        ...
        console.log(data); // Javítottam a console.log-ot, hogy a tényleges adatot jelenítse meg
        setRooms(data);
      } catch (error) {
            ...
            <div key={room.room_id || room.room_number || Math.random()} className="bg-white rounded-xl shadow-lg overflow-hidden transform hover:scale-105 transition-all duration-300">
              ...
              <div className="p-4">
                ...
                <div className="space-y-1">
                  ...
                  <p><strong>Befogadó képesség:</strong> {room.capacity ? `${room.capacity} persons` : 'N/A'}</p>
