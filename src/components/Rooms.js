...
function RoomCard() {
  ...
  return (
    ...
    <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <form className="bg-white rounded-2xl shadow-xl p-6 md:p-8 mb-8 md:mb-16 ring-1 ring-gray-100/50 hover:ring-blue-200/50 transition-all duration-500" onSubmit={(e) => e.preventDefault()}>  <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
