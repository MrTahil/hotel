...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2025. Már 20. 11:21
...
('TV', 'Tv mit akarsz', 1, 'Elérhető', '2025-03-20', 1, 'Rendben', 'Tv', 'Technológia', 3),
('Királyi Ágy', 'Óriás méretű ágy', 2, 'Elérhető', '2025-03-20', 10, 'Rendben', 'Bed', 'Ágy', 3),
('Nagy Tv', 'Szép lapos', 3, 'Nem elérhető', NULL, 10, 'Javítás alatt', 'Tv', 'Technológia', 3),
('Törölközők', 'fürdő és kéztörlők', 4, 'Elérhető', NULL, 10, 'Rendben', 'Laundry', 'Alapvető kényelem', 3),
('Ébresztőszolgáltatás', 'Felkeltenek ha kéri', 5, 'Elérhető', '2025-03-20', 4, 'Rendben', 'Alarm', 'Ébresztés', 3),
...
('Minibár', 'italok, snackek', 7, 'Elérhető', NULL, 10, 'Rendben', 'Tapas', 'Technológia', 2),
('Szobai széf', 'Széf', 8, 'Elérhető', NULL, 10, 'Rendben', 'lOCK', 'Technológia', 3),
('Napi Takarítás', 'Kitakarítanak minden nap amennyiben igényli', 9, 'Elérhető', '2025-03-20', NULL, 'Rendben', 'Mop', 'Takarítás', 5),
...
(5, 7, 4, '2025-03-20', '2025-03-23', 1, 15000, '2025-03-20', 'Jóváhagyva', 'Fizetésre vár');
...
(10, 3500, 'Available', 3, 'Bortúra', '2025-03-25', 'Tokaj szőlőhegyek', 'Szereted a természetet, a madárcsicsergést, és netán a bort? Ezesetben gyere kóstoljatok bele a Tokaji szőlőhegyek termésébe!', '2025-03-12', 'Zelenák Zalán Noel', '+36 70 323 7436', '../img/bor.png'),
(5, 10000, 'Available', 4, 'Csillagászat', '2025-04-16', 'Hotelünk B2 épületének 15. emeletén található csillagászati szoba', 'Éjjeli bagoly vagy? Szereted az égitesteket? Gyere nézd meg őket!', '2025-03-12', 'Dr. Pozsgai Marcell TT.', 'pozsgaim@kkszki.hu', '../img/csillag.png'),
...
(6, 7, '0001-01-01', 15000, 'Készpénz', '0', 'Fizetésre vár', 'Huf', '', '2025-03-20');
...
('Single', 1, '999', 1, 20000, 'Available', 'Ez a teszt szoba', 1, NULL, '2025-03-20', '../img/single_room.png'),
...
('Deluxe', 19, '110', 2, 18000, 'Occupied', 'Egyszerű, de kényelmes szoba alacsonyabb árkategóriában.', 1, NULL, '2025-03-06', '../img/deluxe_room.png\n'),
...
('Tahil', 3, 'hte+RnleAunUji+Bx3f7EPd8Nd2nOw82PS50E6kPBYOBYQ+8JUKlArMigzjZ1CM3', 'hiloczkit@kkszki.hu', 'System', 'g7+0UEWm3a27OLDaqGAIU12rNuCqftn/dq4buoiSml8=', '2025-03-27', 'string', '2025-01-16', '2025-01-16', '2025-01-16', 'string', '111111', '2025-02-13'),
